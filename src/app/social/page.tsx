  ...
  const socialSuits = [
    {
      ...
      name: "Cinto Básico",
      price: "R$  47,00",
      image: "https://http2.mlstatic.com/D_NQ_NP_2X_656837-MLB79177590628_092024-F-cinto-basico-3cm-de-largura-unissex-tradicional-vegano.webp",
      rating: 4.9
    },
    {
      id: 2,
      name: "Cinto Premium",
      price: "R$ 97,00",
      image: "https://http2.mlstatic.com/D_NQ_NP_2X_766228-MLB45015075888_022021-F-cinto-masculino-basico-35cm-couro-sintetico-tradicional.webp",
      rating: 4.8
    },
    {
      id: 3,
      ...
      price: "R$  120,00",
      image: "https://http2.mlstatic.com/D_NQ_NP_2X_963935-MLB84326304160_052025-F-camisa-social-masculina-slim-fit-premium-pronta-entrega.webp",
      rating: 4.9
    },
    {
      id: 4,
      name: "Camisa Social",
      price: "R$ 100,00",
      image: "https://http2.mlstatic.com/D_NQ_NP_2X_738471-MLB92186107752_092025-F-camisa-social-masculina-slim-fit-premium-pronta-entrega.webp",
      rating: 4.7
    },
    {
      id: 5,
      name: "Gravata Slim",
      price: "R$ 30,00",
      image: "https://images.unsplash.com/photo-1598032895468-e81825029202?q=80&w=764&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      rating: 4.8
    },
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-indigo-900 to-blue-800 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Sociais</h1>
      ...
      <div className="bg-gray-100 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <blockquote className="text-2xl font-medium text-gray-900 mb-6">
            "Desde que comecei a usar os ternos da LFTernos, minha presença em reuniões mudou completamente. 
